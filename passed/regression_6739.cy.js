...
describe("dcTrack front-end testing ", () => {
  ...
  it("Clone A NEW BLADE2 and bring it to off-site", () => {
    ...
    cy.getIframeBody('id="assets_iframe"')
      ...
      .parent()
      .find("input")
      .type("TEST-PORT PLACEMENT{enter}");
    cy.wait(2000);
    cy.getIframeBody('id="assets_iframe"')
      .find("#cmbSlotPosition-selectized")
      .click()
  ...
  it("Bring them on site and verify the error message", () => {
    ...
    cy.wait(6000);
    cy.getIframeBody('id="assets_iframe"')
      .contains("div", "A NEW BLADE-CLONE1")
      .click();
    cy.getIframeBody('id="assets_iframe"')
      .contains("div", "A NEW BLADE-CLONE2")
      .click({ ctrlKey: true });
    cy.wait(2000);
    cy.getIframeBody('id="assets_iframe"')
      .find("#itemList")
    ...
    cy.get("@dropdown")
      .eq(2)
      .find("span", "Bring Item On-site Request")
      .click();
    cy.getIframeBody('id="assets_iframe"').find("#modal-btnOk").click();
    cy.wait(12000);
    cy.getIframeBody('id="assets_iframe"')
      ...
      .should(($t) => {
        ...
        const errorMsg =
          "Bring On-site: A NEW BLADE-CLONE2. Item A NEW BLADE-CLONE2 cannot be Installed because its Network / Chassis is not in the Installed status and is not included in this work order.";
