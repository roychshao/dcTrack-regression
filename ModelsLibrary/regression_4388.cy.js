...
describe("dcTrack front-end testing ", () => {
  ...
  it("Verify options", () => {
    ...
    cy.getIframeBody('id="models_iframe"')
      ...
      .click();
    cy.getIframeBody('id="models_iframe"')
      .contains("div", "Single Phase (3-Wire)")
      .parent()
      .click();
    cy.wait(2000);
    cy.getIframeBody('id="models_iframe"')
      ...
      .parent()
      .dblclick();
    cy.getIframeBody('id="models_iframe"').contains(
      "div",
      "Single Phase (3-Wire)",
    );
    cy.getIframeBody('id="models_iframe"').contains(
    ...
    cy.getIframeBody('id="models_iframe"').contains("div", "Three Phase Delta");
    cy.getIframeBody('id="models_iframe"').contains("div", "Three Phase Wye");
  });
});
