Cypress.Commands.add('getIframeBody', (attribute) => {
  ...
  describe('dcTrack front-end testing ', () => {
    ...
    it('Verify if the default connection is To Data Panel', () => {
      cy.getIframeBody('id="assets_iframe"').find('#dct-capacity-modal-content').as('model content')
      cy.get('@model content').find('#dataPortGroup').click()
      cy.getIframeBody('id="assets_iframe"').find('.ui-grid-canvas').contains('div', 'To Data Panel')
