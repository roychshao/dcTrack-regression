Cypress.Commands.add('getIframeBody', (attribute) => {
  ...
  describe('dcTrack front-end testing ', () => {
    ...
    it('Fill up the Row Label field, save and check if the "Processing Completed" string exists', () => {
      cy.wait(4000)
      ...
      cy.wait(8000)
      cy.getIframeBody('id="assets_iframe"').find('#idItemRequestDiv').find('label', 'Processing Completed.').should('exist')
