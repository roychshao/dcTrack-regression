Cypress.Commands.add('getIframeBody', (attribute) => {
  ...
  describe('dcTrack front-end testing ', () => {
    ...
    it('Check if the progress section contains 1. request number 2. request type 3. item name', () => {
      cy.wait(30000)
      cy.getIframeBody('id="assets_iframe"').find('#idItemRequestDiv').contains('label', /101, Request: .*, Move: 101/i)
