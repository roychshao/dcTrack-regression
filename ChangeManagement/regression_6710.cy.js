...
describe("dcTrack front-end testing ", () => {
  ...
  it("Clone A NEW BLADE2 and bring it to off-site", () => {
    ...
    // do not fill up the slot position, this can make the request failed and won't be issued
    cy.wait(4000);
    cy.getIframeBody('id="assets_iframe"')
      .find("#itemDetail")
      .find('[title="Save"]')
  ...
  it("Bring them on site and verify the message", () => {
    cy.wait(2000);
    cy.getIframeBody('id="assets_iframe"')
      .find("#inner-scroller")
      .find("#btnRemoveTab")
  ...
  it("Should only have one complete request", () => {
    cy.wait(2000);
