...
describe("dcTrack front-end testing ", () => {
  ...
  it("Verify error message", () => {
    ...
    const errMsg1 =
      "DCPLANTITEM,DCFAP_ITEM1,DEVICEDC,DCPLANTPANEL,DCPANEL, Request failed, ";
    const errMsg2 =
      "You cannot complete this Work Order because it involves connections to items that have not yet been Installed.";
  ...
  it("Check the stage of the request and cancel it", () => {
    cy.getIframeBody('id="change_iframe"')
      ...
      .dblclick();
    cy.getIframeBody('id="change_iframe"')
      .find("#cmbRequestStage")
      .should("have.value", "Request Issued");
    cy.wait(2000);
    cy.getIframeBody('id="change_iframe"')
